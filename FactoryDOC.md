...
1. **Deploy Factory**
```bash
dfx deploy market_factory --with-cycles 10000000000000
```

2. **Set Yourself as Admin**
```bash
dfx canister call market_factory setAdmin "(principal \"$(dfx identity get-principal)\")"
```
...
```bash
dfx deploy markets_canister
dfx canister call market_factory setMarketsCanister "(principal \"$(dfx canister id markets_canister)\")"
```

5. **Configure Network**
```bash
# For mainnet
dfx canister call market_factory setNetwork "(true)"
