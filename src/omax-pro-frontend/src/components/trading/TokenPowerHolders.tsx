      ...
      <CardHeader>
        ...
        <div className="md:hidden mt-4 space-y-3">
          ...
          <div className="flex items-center gap-2 text-xs text-muted-foreground bg-muted/50 rounded-lg p-2">
            ...
            <span>BTC: ${(btcPriceUSD / 1000).toFixed(0)}K</span>
      ...
      <CardContent>
        {powerHolders.length === 0 ? (
          ...
          <div className="space-y-4">
            {/* Desktop BTC Price Display */}
            <div className="hidden md:flex items-center justify-between text-sm text-muted-foreground bg-muted/50 rounded-lg p-2">
              <div className="flex items-center gap-2">
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-right hidden sm:table-cell">% Supply</TableHead>
