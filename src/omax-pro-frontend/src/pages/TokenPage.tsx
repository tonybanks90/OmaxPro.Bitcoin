...
async function fetchOdinToken(tokenId: string): Promise<OdinTokenData> {
  const response = await fetch(`${ODIN_API_BASE}/token/${tokenId}?env=development`);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6" data-testid="page-token">
        <div className="flex flex-col items-center justify-center min-h-[400px]">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-foreground mb-2">Token Not Found</h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div>
                  ...
                  <div className={`text-lg font-bold ${
                    change24hPercent.startsWith('+') ? 'text-success' : 'text-destructive'
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-xs font-medium text-foreground" data-testid="text-token-age">
                    {getTimeAgo(token.created_time)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-xs text-muted-foreground">Token ID</span>
                  <span className="text-xs font-medium text-foreground" data-testid="text-token-id">
                    {token.id}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-foreground" data-testid="text-token-holders">
            ...
            <CardContent>
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-sm font-medium text-foreground" data-testid="text-price-detailed">
                    {formatPrice(token.price)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Market Cap</span>
                  <span className="text-sm font-medium text-foreground" data-testid="text-market-cap-detailed">
                    {formatNumber(token.marketcap)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">24h Volume</span>
                  <span className="text-sm font-medium text-foreground" data-testid="text-volume-detailed">
                    {formatNumber(token.volume_24)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Holder Count</span>
                  <span className="text-sm font-medium text-foreground" data-testid="text-holders-detailed">
                    {token.holder_count.toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">Created</span>
                  <span className="text-sm font-medium text-foreground" data-testid="text-created-detailed">
                    {getTimeAgo(token.created_time)}
                  </span>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-sm text-muted-foreground">24 hours ago</span>
                  <div className="text-right">
                    <div className="text-sm font-medium text-foreground">
