// ==========================================
// NEW PREDICTION MARKETS: ASSET VAULT
// ==========================================
// This canister securely holds all assets (ckBTC) for prediction markets.
// KEY FEATURES:
// 1. Subaccount Isolation: Uses unique subaccounts for each market to ensure fund segregation.
// 2. Controlled Access: Only authorized MarketTrade canisters can pull/pay funds.
// 3. Audit Trail: Tracks detailed statistics for deposits, withdrawals, and volume per market.
// ==========================================
