// ==========================================
// NEW PREDICTION MARKETS: MARKET FACTORY
// ==========================================
// This canister is responsible for creating new prediction markets using the ICRC-151 standard.
// KEY FEATURES:
// 1. ICRC-151 Integration: Deploys a SINGLE ledger for multiple outcome tokens, saving ~0.85T cycles per market.
// 2. Automated Setup: Orchestrates the creation of tokens, registration with the trading engine, and vault setup.
// 3. Scalable Architecture: Decouples token creation from trading logic.
// ==========================================
