// ==========================================
// NEW PREDICTION MARKETS: TRADING ENGINE
// ==========================================
// This canister manages the trading logic for Prediction Markets.
// KEY FEATURES:
// 1. Bonding Curve Pricing: Implements a Linear Bonding Curve for continuous liquidity and automated market making.
// 2. Multi-Market Support: Handles Binary, Multiple Choice, and Compound markets seamlessly.
// 3. Mathematical Precision: Uses quadratic formula for precise share/cost calculations (sats <-> shares).
// ==========================================
