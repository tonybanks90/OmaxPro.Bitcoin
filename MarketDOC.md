...
# register Vault
dfx canister call Markets setVaultCanister '(principal "umunu-kh777-77774-qaaca-cai")'

#register MarketFactory
dfx canister call Markets setTokenFactory '(principal "uzt4z-lp777-77774-qaabq-cai")'
```
